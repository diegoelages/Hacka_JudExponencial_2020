...
class NERJuridico:   
    ...
    def traduzir(self, Texto):
        ...
        for ent in doc.ents:
            #self.retorno.append({'cor':self.cores[self.tags.index(ent.label_)], 'palavras':ent.text, 'significado':self.df[self.df['TERMO']==ent.text.strip()]['SIGNIFICADO']})
